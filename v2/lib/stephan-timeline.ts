import type { Task, Decision, CalendarEvent } from "./cockpit";
...
export function findChatCreatedItems(d: { tasks: Task[]; decisions: Decision[]; calendarEvents: CalendarEvent[] }): ChatCreatedItem[] {
