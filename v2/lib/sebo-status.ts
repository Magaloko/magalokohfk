export const SEBO_STATUS = {
  ...
  openP1: [
    "5k-Projekt mit Pilot, Abnahme und Dokumentation abschließen.",
    "analytics_sales per CSV-Import und Matching weiter befüllen.",
    "Bestellhistorie fertigstellen und testen.",
    "Automatische Erstantworten testen, aber erst nach Freigabe produktiv aktivieren.",
  ],
  openP2: [
    "JTL-Sync für Sales-Daten langfristig automatisieren.",
    "Rule-Engine vs. Power Automate mit Stephan klären.",
    "Outlook-Templates pro Kategorie als schnelle Vorerfassung.",
    "React-PWA für strukturierte Fallanlage mit Foto-Upload.",
  ],
  nextSteps: [
    "5k-Abnahmeplan erstellen und gegen ursprünglichen Auftrag halten.",
    "analytics_sales zuerst per Test-Batch, dann stabil per Import/Matching befüllen.",
