...
export const SEBO_SYSTEM_STATUS = {
  ...
  mission: {
    title: "SeBo ist das operative Gesamtsystem für HFK",
    summary:
      "SeBo bündelt JTL-Analytics-Sync, Einkaufsplaner, v2.0 Case-Management, Treasury/Cashflow und weitere Module wie Billing, VIPA und VEKTRA. Ziel ist ein datengetriebenes Dashboard, das Stephan konsistente Entscheidungen über Einkauf, Service, Liquidität und operative Steuerung ermöglicht.",
    guardrail:
      "Keine Container-Restarts oder Deploys während laufendem JTL-Sync ohne explizites Go. Additiv arbeiten, Feature-Flags für v2.0-Funktionen nutzen und vor Commit npx tsc --noEmit ausführen.",
  },
  modules: [
    {
      key: "jtl-sync",
      ...
      details: [
        "In-Memory Poller lib/jtl-poller.ts läuft alle 5 Minuten.",
        "Produkte-Sync hat Priorität, Stand laut Dokumentation: Seite ca. 1521/9755.",
    ...
    },
    {
      ...
      purpose: "Bestellvorschläge unter Budget-, DB1-, Marken- und OOS-Gesichtspunkten generieren.",
      details: [
        ...
        "Optimizer-Änderungen immer zusammen mit API und UI anfassen.",
      ],
    },
    {
      key: "case-management",
      ...
      status: "ca. 60 %",
      tone: "amber" as SystemTone,
      purpose: "Ticket- und Fall-Management mit KI-Unterstützung für E-Mail, WhatsApp und Telefon.",
      details: [
    ...
    },
    {
      ...
      status: "Produktiv",
      tone: "green" as SystemTone,
      purpose: "Liquidität überwachen und große Bestellungen gegen Cashflow-Risiken prüfen.",
      details: [
    ...
    },
    {
      ...
      details: [
        "Billing-Modul für Rechnungs- und Zahlungsfälle ist in Entwicklung.",
        "VIPA und VEKTRA haben Basisfunktionen in der Magaloko-App.",
        "Reminder-Engine läuft über /api/cron/reminders.",
      ],
    },
  ],
  mastermind: [
    { phase: "P0", topic: "Treasury-Order-Ampel", status: "Produktiv", tone: "green" as SystemTone, detail: "Orders >= 2.000 EUR gegen Cashflow-Forecast prüfen." },
    ...
    { phase: "P1.2", topic: "Kategorie-Regeln", status: "Teilweise", tone: "amber" as SystemTone, detail: "KiWa/Möbel kein Autopilot, Saisonmode +30 %, Spielzeug Q4 +20 %." },
    ...
    { phase: "P2", topic: "Rhythm-Break Detection", status: "Offen", tone: "red" as SystemTone, detail: "Plötzliche Nachfragebrüche erkennen." },
    { phase: "P2", topic: "Top-20 / Markdown-Steuerung", status: "Offen", tone: "red" as SystemTone, detail: "Manuelle Steuerung für strategische Artikel." },
  ],
  syncChange: {
    title: "JTL-Produktfilter seit 26.06.2026",
    points: [
      "Vorher wurden Artikel mit EK <= 0 ausgeschlossen.",
      "Vorher wurden Artikel ausgeschlossen, die älter als 3 Jahre sind.",
      "Jetzt werden alle aktiven Artikel mit IsActive === true synchronisiert.",
      "Artikel ohne EK und ältere Artikel landen dadurch ebenfalls in analytics_products.",
      "Auswirkung: längerer Sync, aber vollständigere Datengrundlage.",
    ],
  },
  rules: [
    "Immer additiv arbeiten; keine bestehenden Tabellen oder Spalten löschen.",
    "Feature-Flags für v2.0-Funktionen nutzen.",
    "Keine Container-Restarts oder Deploys während laufendem JTL-Sync ohne explizites Go.",
    "Vor jedem Commit npx tsc --noEmit ausführen.",
    "Bei Einkaufs-Optimizer-Änderungen immer UI und API-Route mitanpassen.",
    "chatComplete() gibt { message: { content } } zurück, nicht direkt result.content.",
  ],
  summary: [
    ...
    { label: "Case-Management", value: "60 %", tone: "amber" as SystemTone, note: "Grundgerüst + Immediate Features" },
