...
const SECTIONS: Section[] = [
  ...
  { title: "Steuerung", adminOnly: true, items: [
    ...
    { href: "/cockpit/sebo", label: "Service / SeBo", icon: "chat", adminOnly: true },
    { href: "/cockpit/tasks", label: "Tasks", icon: "check", adminOnly: true },
    { href: "/cockpit/entscheidungen", label: "Entscheidungen", icon: "compass", adminOnly: true },
    { href: "/cockpit/umsetzung", label: "Wartet auf", icon: "handshake", adminOnly: true },
    { href: "/cockpit/briefing", label: "Stephan-Update", icon: "send", adminOnly: true },
    { href: "/cockpit/aktivitaet", label: "Aktivität", icon: "clock", adminOnly: true },
    { href: "/cockpit/stephan", label: "Stephan-Assist", icon: "chat", adminOnly: true },
    { href: "/cockpit/dokumentation", label: "Dokumentation", icon: "book", adminOnly: true },
        ...
        <div className="fixed inset-0 z-40 md:hidden">
          ...
          <aside className="absolute left-0 top-0 h-full w-72 border-r border-line bg-surface">
            <div className="flex items-center justify-between px-4 py-5">
              <Link href={homeHref} onClick={() => setOpen(false)} className="font-extrabold">VEKTRA</Link>
