...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    const messages: ChatMsg[] = [{
      role: "user",
      content: `Eingehende Nachricht von Stephan (Auftraggeber):\n"""\n${message}\n"""\n\nEntwirf in Magos Namen eine Antwort an Stephan – ausschließlich auf Basis der MasterMind-Wissensbasis. Was nicht belegt ist, ausdrücklich als fehlend kennzeichnen.`,
    }];
